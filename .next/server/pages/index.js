...
const getStaticProps = async () => {
  // Fetch data from API
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://Anish_MB:importMongo@cluster0.3udzw.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
...
/* harmony default export */ var pages = __webpack_exports__["default"] = (HomePage); // Run always on the Server after Build Process
